...
/**
 * 执行追踪（调试视图）：原「Agent 雷达」页。
 * 面向开发者的执行记录日志 —— 保留 ?debug 入口，正常客户入口不展示。
 */
export default function AgentDebugPage({ messages, conversationTitle, loading, error, canRefresh,
  hasOlder, loadingOlder, onRefresh, onLoadOlder, onBack }: AgentDebugPageProps) {
        ...
        <div className="mx-auto flex max-w-4xl flex-wrap items-center justify-between gap-3">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <h1 id="radar-title" className="text-lg font-semibold">执行追踪 · 调试</h1>
